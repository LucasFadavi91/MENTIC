  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #007bff;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="../controllers/controller_menu_principal.php">Menú principal<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3"><span>La comunidad del anillo</span>
                  <a href="../views/tests/test1"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <h6>What is Lorem Ipsum?What is Lorem Ipsum?What is Lorem Ipsum?What is Lorem Ipsum?</h6>
                <div class="d-flex justify-content-between install mt-3"><span>Las dos torres</span>
                  <a href="../views/tests/test2"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
