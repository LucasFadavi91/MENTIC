    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card p-3">
                ...
                <h6>What is Lorem Ipsum?What is Lorem Ipsum?What is Lorem Ipsum?</h6>
                <div class="d-flex justify-content-between install mt-3"><span>Las dos torres</span><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3">
