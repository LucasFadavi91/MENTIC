...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
                    ...
                    <div class="col-md-12 mx-auto">
                        ...
                        <div id="second">
                            <div class="col-md-5 mx-auto">
                                <img id="world" src="./../img/world.png">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="sectionh2">
        <article>
            <div class="container">
                <div class="col-md-12 mx-auto text-center">
                    <br>
                    <h2>Cada lección es como un juego</h2>
                </div>
            </div>
        </article>
    </section>
                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="col-md-12 mx-auto">
                            <div>
                                <hr>
                                <br>
                                <h3>Impulsa tu aprendizaje con Mentic Plus</h3>
                                <div class="">
                                    ...
                                    <h3 style="color:royalblue;">Más información sobre Mentic Plus</h3>
                                    <br>
                                    <hr>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="media border-none">
                    <div class="col-md-12 mx-auto">
                        ...
                        <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
