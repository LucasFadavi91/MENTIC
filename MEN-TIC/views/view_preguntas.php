    ...
    <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseTen" class="panel-collapse collapse">
                <div class="panel-body">
                    Esta aplicación tiene la finalidad de ayudar a profundizar y aclarar contenidos relacionados con el módulo, además de poder proporcionaros una herramienta más para poder repasar los contenidos teóricos y prácticos del módulo y de cada una de las unidades de trabajo que se ven a lo largo del módulo.
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseThree" class="panel-collapse collapse">
                <div class="panel-body">
                    Los puntos sirven para avanzar en los niveles y en las pruebas que componen los subniveles. Aunque el objetivo de esta aplicación no es generar competitividad entre los usuarios, sino crear una motivación para seguir completando las pruebas.
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">¿Qué módulos están incluidos en esta aplicación?</a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseMoo">¿Qué unidades de trabajo están incluidas?</a>
                </h4>
            </div>
