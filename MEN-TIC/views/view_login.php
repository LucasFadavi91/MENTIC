                        ...
                        <div id="first">
                            <div class="myform form ">
                                ...
                                <form action="" method="post" name="login">
                                    ...
                                    <div class="form-group">
                                        <p class="text-center small">Al hacer clic en Registrarte, aceptas nuestros <label style="font-size: 12px;color: rgb(0, 109, 255);" class="terminos" for="lightbox-1">Terminos de uso</label></p>
                                    </div>
                                    <div class="col-md-12 text-center ">
