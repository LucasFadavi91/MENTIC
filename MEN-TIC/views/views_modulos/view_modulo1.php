          ...
          <div class="col-md-4">
              <div class="card-sl">
                  <div class="card-image">
                      <img
                            src="../../img/imagenes_niveles/nivel1.png" width="350px" height="233px" />
                    </div>
                    ...
                    <div class="card-heading night-mode-available">
                     ...
                     <div class="card-text night-mode-available">
                        <h6>Introducción a la Intervención Psocisocial</h6>
                    </div>
                    <div class="card-text night-mode-available">
                        <p class="test1">La primera unidad de trabajo recoge diferentes aspectos relacionados con conceptos básicos que serán necesarios para entender de manera completa la dimensión biopsicosocial de las personas y usuarios con los que trabajaréis en el futuro.
                        <!--Se incluyen también aspectos importantes relacionados con la psicología y las funciones cognitivas del ser humano, tanto básicas como superiores, así como la importancia de las emociones y sentimientos y de la inteligencia emocional en las personas.
                        ...
                        ¡Ánimo!!! Comenzamos una aventura que te dirige a profundizar y afianzar los contenidos trabajados y los conocimientos que irás adquiriendo a lo largo de este curso y de este módulo.--></p>
                    </div>
