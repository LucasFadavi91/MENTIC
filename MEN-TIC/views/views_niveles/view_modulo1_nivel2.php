        ...
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../controllers/controllers_subniveles_nivel2/controller_modulo1_nivel2_subnivel1.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../controllers/controllers_subniveles_nivel2/controller_modulo1_nivel2_subnivel2.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../controllers/controllers_subniveles_nivel2/controller_modulo1_nivel2_subnivel3.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../controllers/controllers_subniveles_nivel2/controller_modulo1_nivel2_subnivel4.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../controllers/controllers_subniveles_nivel2/controller_modulo1_nivel2_subnivel5.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
    </div>
</div>
...
<div id="subnivel1" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> 
  <div class="modal-dialog modal-lg">
    <div class="modal-content night-mode-available">
      ...
      Qué nuestra actitud sea “adecuada” dependerá o estará relacionado con los diferentes componentes con los que están relacionadas las habilidades sociales: los conductuales, los cognitivos y los fisiológicos.Vamos a ver ahora si los contenidos vistos han echado raíces o tenemos que seguir regándolos.<br>
