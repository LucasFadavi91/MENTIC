        ...
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../views/tests/tests_subniveles_nivel2/test1"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../views/tests/tests_subniveles_nivel2/test2"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../views/tests/tests_subniveles_nivel2/test3"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../views/tests/tests_subniveles_nivel2/test4"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a href="../../views/tests/tests_subniveles_nivel2/test5"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
    </div>
</div>
