        ...
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
                ...
                <div class="d-flex justify-content-between install mt-3">
                  ...
                  <a id="sub1" href="../../controllers/controllers_subniveles_nivel1/controller_modulo1_nivel1_subnivel2.php"><span class="text-primary">Realizar Test&nbsp;<i class="fa fa-angle-right"></i></span></div></a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 effect night-mode-available">
