          ...
          <div class="dropdown-menu night-mode-available" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item night-mode-available" href="#">Modulo 2</a>-->     
              <?php foreach($userModulos=getUserModulos($_SESSION["id_user"]) as $value) : ?>
                  <a class="dropdown-item night-mode-available" href="../controllers/controllers_modulos/controller_modulo1.php">
                   <?php echo $value ?> </a>   
              <?php endforeach; ?> 
              <!--<?php /*echo "<a class='dropdown-item night-mode-available' href='../controllers/controllers_modulos/controller_modulo1.php'>" . $value. "</a>";*/?>-->      
          </div>
        </li>
        <li class="nav-item dropdown ">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
