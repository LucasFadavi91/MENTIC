                    ...
                    <div id="first">
                       ...
                       <br>
                        <div class="myform form night-mode-available">
                            ...
                            <br>
                            <div class="col-md-12 text-center ">
                                <button type="button" onclick="window.location.href='../controllers/controller_category_one.php'" name="asignatura1" id="asignatura1" class=" btn btn-block mybtn btn-primary tx-tfm">Módulo 1</button>
