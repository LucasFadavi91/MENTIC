...
<body oncontextmenu='return false' class='snippet-body night-mode-available'>
  ...
  <h1> Tema 5. </h1>
    ...
    <img width="700px" class="centrarimagen img-fluid" src="../../img/temas/tema5/intro.png"> <br><br><br>
    <div> <!-- Párrafo 1 -->
      <img class="img-fluid" width="450px" src="../../img/temas/tema5/frases.png" style="float:right; margin-left:20px;">
      <h3> Introducción. </h3>
    ...
    <div> <!-- Párrafo 2 -->
      <img class="img-fluid" width="120px" src="../../img/temas/tema5/cabeza.png" style="float: left;">
    ...
    <div> <!-- Párrafo 4 -->
      ...
      <ul>
        ...
        <li> <span class="negrita">Personas con demencia: </span><br>
          ...
          <table border="2" id="tgrande" class="table-responsive">
            <tr>
    ...
    <div> <!-- Párrafo 6 -->
      ...
      <ul>
        ...
        <li> <span class="negrita"> La Psicomotricidad: </span><br>
          ...
          <table border="2" class="tablacentro table-responsive" style="color: black;" id="tablapsico">
            <tr>
              <th>Area</th>
              <th>Definición</th>
