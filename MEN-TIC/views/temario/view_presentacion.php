...
<body oncontextmenu='return false' class='snippet-body night-mode-available'>
  ...
  <div class="container night-mode-available">
    <h1> Presentación del módulo </h1><br><br>
    <img class="img-fluid centrarimagen" src="../../img/temas/presentacion/intro.png"><br><br>
    Esta aplicación tiene la finalidad de ayudar a profundizar y/o aclarar contenidos relacionados con el módulo, además de poder proporcionaros una herramienta  más para poder repasar los contenidos teóricos y prácticos del módulo y de cada una de las unidades de trabajo que veremos a lo largo del curso.<br>
    Se recogen todas las unidades de trabajo y diferentes niveles, relacionados cada uno con una unidad de trabajo. Cada nivel está dividido en 5 subniveles con diferentes preguntas sobre los contenidos de la unidad de trabajo.<br>
    Cada nivel y subnivel se irá abriendo progresivamente a medida que se vayan superando los anteriores.<br>
    Disfruta del proceso, reflexiona sobre las respuestas que no sean correctas, repasa los contenidos teóricos y vuelve a intentarlo las veces que consideres necesario.<br><br>
    <div style="font-size: 50px; font-weight: bolder; text-decoration: underline; text-align: center;">
