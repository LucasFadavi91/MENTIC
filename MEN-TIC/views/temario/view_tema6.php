...
<body oncontextmenu='return false' class='snippet-body night-mode-available'>
  ...
  <div class="container night-mode-available">
    <h1> Tema 6. </h1>
      ...
      <img width="800px" class="centrarimagen img-fluid" src="../../img/temas/tema6/intro.png"> <br><br><br>
      <div> <!-- Párrafo 1 -->
        <img class="img-fluid" width="600px" src="../../img/temas/tema6/frases.png" style="float:right; margin-left:20px;">
        <h3> Introducción. </h3>
      ...
      <div> <!-- Párrafo 2 -->
        <img class="img-fluid" width="120px" src="../../img/temas/tema6/bola.png" style="float: left; margin-right: 20px;">
