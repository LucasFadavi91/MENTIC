...
<body oncontextmenu='return false' class='snippet-body night-mode-available'>
  ...
  <h1> Tema 4. </h1>
    ...
    <img width="700px" class="centrarimagen img-fluid" src="../../img/temas/tema4/intro.png"> <br><br><br>
    <div> <!-- Párrafo 1 -->
      <img class="img-fluid" width="600px" src="../../img/temas/tema4/frases.png" style="float:right; margin-left:20px;">
      <h3> Introducción. </h3>
      ...
      <div class="cuadro centrarimagen col-md-12 mx-auto">
        ...
        <li> <span class="negrita"><span class="sub"> TÉCNICAS PARA LA ADQUISICIÓN DE NUEVAS CONDUCTAS </span></span><br><br>
          ...
          <ul>
            ...
            <li>Secuencia detallada de cepillado de dientes:<br><br>
              <img width="850px" class="centrarimagen img-fluid" src="../../img/temas/tema4/cepillado.png">
            </li>
          </ul>
