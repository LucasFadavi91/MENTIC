...
<body oncontextmenu='return false' class='snippet-body night-mode-available'>
  ...
  <div class="container night-mode-available">
    ...
    <img width="700px" class="centrarimagen img-fluid" src="../../img/temas/tema3/intro.png"> <br><br><br>
    <div> <!-- Párrafo 1 -->
      <img class="img-fluid" src="../../img/temas/tema3/frases.png" style="float:right; margin-left:20px;">
      <h3> Introducción. </h3>
      ...
      <ul>
        ...
        <ul>
          ...
          <li> <span class="negrita"><span class="sub"> ¿Las inteligencias múltiples? </span></span><br>
            ...
            <img class="img-fluid" src="../../img/temas/tema3/inteligencia.png" style="float:left; margin-right: 25px;">
      ...
      <ul class="mayus">
        <li> <span class="negrita">Conductismo ()</span><br>
          ...
          <ul>
            ...
            <table border="2" class="tablacentro table-responsive">
        ...
        <li> <span class="negrita">Aprendizaje por mediación (L. Vygostsky)</span><br>
          ...
          <img width="600px" class="centrarimagen img-fluid" src="../../img/temas/tema3/aprendizaje.png">
        </li><br>
