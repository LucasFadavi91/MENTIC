  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #007bff;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="../controllers/controller_menu_principal.php">Menú principal</a>
        </li>
        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tab-content profile-tab" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="col-md-6"> 
                                    <label>Registrado desde</label> <!-- EMAIL -->
                                </div>
                                <div class="col-md-6">
                                    <p><?php echo htmlspecialchars($_SESSION["fechadesde"]) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
